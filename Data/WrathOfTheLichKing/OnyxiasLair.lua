    ...
    bosses = {
        {
            ...
            loot = {
                ...
                { id = 49482, slot = "Head", name = "Aurora of Transcendence", sources = { [4]=24194 } },
                { id = 49477, slot = "Head", name = "Bloodfang Hood", sources = { [4]=24189 } },
                { id = 49322, slot = "Head", name = "Bloodfang Mask", sources = { [3]=24078 } },
                { id = 49316, slot = "Head", name = "Circlet of Transcendence", sources = { [3]=24072 } },
                { id = 49331, slot = "Head", name = "Coif of Ten Storms", sources = { [3]=24087 } },
                { id = 49317, slot = "Head", name = "Coronet of Transcendence", sources = { [3]=24073 } },
                { id = 49330, slot = "Head", name = "Cowl of Ten Storms", sources = { [3]=24086 } },
                { id = 49469, slot = "Head", name = "Crown of Ten Storms", sources = { [4]=24181 } },
                { id = 49480, slot = "Head", name = "Dragonstalker's Helm", sources = { [4]=24192 } },
                { id = 49319, slot = "Head", name = "Dragonstalker's Helmet", sources = { [3]=24075 } },
                { id = 49320, slot = "Head", name = "Faceguard of Wrath", sources = { [3]=24076 } },
                { id = 49467, slot = "Head", name = "Frostforged Greathelm", sources = { [4]=24179 } },
                { id = 49466, slot = "Head", name = "Frostforged Helm", sources = { [4]=24178 } },
                { id = 49333, slot = "Head", name = "Frostforged Helmet", sources = { [3]=24089 } },
                { id = 49332, slot = "Head", name = "Frostforged Ringhelm", sources = { [3]=24088 } },
                { id = 49329, slot = "Head", name = "Gaze of Ten Storms", sources = { [3]=24085 } },
                { id = 49321, slot = "Head", name = "Greathelm of Wrath", sources = { [3]=24077 } },
                { id = 49483, slot = "Head", name = "Halo of Transcendence", sources = { [4]=24195 } },
                { id = 49468, slot = "Head", name = "Helm of Ten Storms", sources = { [4]=24180 } },
                { id = 49479, slot = "Head", name = "Helm of Wrath", sources = { [4]=24191 } },
                { id = 49470, slot = "Head", name = "Helmet of Ten Storms", sources = { [4]=24182 } },
                { id = 49478, slot = "Head", name = "Helmet of Wrath", sources = { [4]=24190 } },
                { id = 49323, slot = "Head", name = "Judgment Cover", sources = { [3]=24079 } },
                { id = 49476, slot = "Head", name = "Judgment Crown", sources = { [4]=24188 } },
                { id = 49475, slot = "Head", name = "Judgment Heaume", sources = { [4]=24187 } },
                { id = 49325, slot = "Head", name = "Judgment Helm", sources = { [3]=24081 } },
                { id = 49324, slot = "Head", name = "Judgment Helmet", sources = { [3]=24080 } },
                { id = 49474, slot = "Head", name = "Judgment Hood", sources = { [4]=24186 } },
                { id = 49484, slot = "Head", name = "Nemesis Skullcap", sources = { [4]=24196 } },
                { id = 49315, slot = "Head", name = "Nemesis Skullcover", sources = { [3]=24071 } },
                { id = 49481, slot = "Head", name = "Netherwind Crown", sources = { [4]=24193 } },
                { id = 49318, slot = "Head", name = "Netherwind Hood", sources = { [3]=24074 } },
                { id = 49327, slot = "Head", name = "Stormrage Antlers", sources = { [3]=24083 } },
                { id = 49473, slot = "Head", name = "Stormrage Cover", sources = { [4]=24185 } },
                { id = 49471, slot = "Head", name = "Stormrage Coverlet", sources = { [4]=24183 } },
                { id = 49472, slot = "Head", name = "Stormrage Crown", sources = { [4]=24184 } },
                { id = 49328, slot = "Head", name = "Stormrage Helm", sources = { [3]=24084 } },
                { id = 49326, slot = "Head", name = "Stormrage Hood", sources = { [3]=24082 } },
