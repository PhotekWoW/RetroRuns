...
RetroRuns_DungeonData[1036] = {
    ...
    bosses = {
        ...
        },
        {
            ...
            loot = {
                { id = 159408, slot = "Chest", name = "Chestguard of the Deep Denizen", sources = { [14]=95197, [15]=95198, [16]=95666 }, twSource = 287945 },
                { id = 159354, slot = "Chest", name = "Hauberk of Sunken Despair", sources = { [14]=95124, [15]=95125, [16]=95843 }, twSource = 287942 },
                { id = 159302, slot = "Head", name = "Cowl of Fluid Machinations", sources = { [14]=95058, [15]=98450, [16]=98451 }, twSource = 287936 },
                ...
                { id = 159244, slot = "Head", name = "Stormlurker's Cowl", sources = { [14]=94984, [15]=95761, [16]=95762 }, twSource = 287933 },
                { id = 159238, slot = "Shoulder", name = "Mantle of Void-Touched Waters", sources = { [14]=94975, [15]=95755, [16]=95756 }, twSource = 287930 },
                { id = 159307, slot = "Shoulder", name = "Tentacle-Laced Spaulders", sources = { [14]=95063, [15]=95064, [16]=98452 }, twSource = 287939 },
