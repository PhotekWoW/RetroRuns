...
RetroRuns_DungeonData[1021] = {
    ...
    bosses = {
        ...
        },
        {
            ...
            loot = {
                { id = 159448, slot = "Chest", name = "Breastplate of the Vengeful", sources = { [14]=95257, [15]=95258, [16]=95693 }, twSource = 287903 },
                { id = 159395, slot = "Chest", name = "Deathslaver's Hauberk", sources = { [14]=95180, [15]=95181, [16]=95875 }, twSource = 287897 },
                { id = 159335, slot = "Chest", name = "Raiment of the Blighted Tribe", sources = { [14]=95103, [15]=98477, [16]=98478 }, twSource = 287891 },
                { id = 159279, slot = "Head", name = "Soulfuel Headdress", sources = { [14]=95031, [15]=95790, [16]=95791 }, twSource = 287888 },
                { id = 159398, slot = "Head", name = "Soulscarred Headgear", sources = { [14]=95186, [15]=95877, [16]=95878 }, twSource = 287900 },
                { id = 159273, slot = "Shoulder", name = "Amice of the Returned", sources = { [14]=95022, [15]=95783, [16]=95784 }, twSource = 287885 },
                { id = 159339, slot = "Shoulder", name = "Gorak Tul's Mantle", sources = { [14]=95107, [15]=95108, [16]=98479 }, twSource = 287894 },
                { id = 159455, slot = "Shoulder", name = "Pauldrons of the Horned Horror", sources = { [14]=95268, [15]=95703, [16]=95704 }, twSource = 287906 },
