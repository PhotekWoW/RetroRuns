...
RetroRuns_DungeonData[1001] = {
    ...
    bosses = {
        ...
        },
        {
            ...
            loot = {
                { id = 158301, slot = "Chest", name = "Ruffled Poet Blouse", sources = { [14]=94296, [15]=94297, [16]=95744 }, twSource = 287970 },
                { id = 155888, slot = "Head", name = "Irontide Captain's Hat", sources = { [14]=92532, [15]=98438, [16]=98439 }, twSource = 287967 },
                { id = 155885, slot = "Head", name = "Sea-Brawler's Greathelm", sources = { [14]=92529, [15]=95655, [16]=95656 }, twSource = 287958 },
                { id = 155886, slot = "Head", name = "Smartly Plumed Cap", sources = { [14]=92530, [15]=95740, [16]=95741 }, twSource = 287961 },
                { id = 155887, slot = "Head", name = "Sweete's Jeweled Headgear", sources = { [14]=92531, [15]=95832, [16]=95833 }, twSource = 287964 },
                { id = 159352, slot = "Shoulder", name = "Gaping Maw Shoulderguard", sources = { [14]=95122, [15]=95122, [16]=95122 }, twSource = 287976 },
                { id = 159299, slot = "Shoulder", name = "Gold-Tasseled Epaulets", sources = { [14]=95052, [15]=95053, [16]=95589 }, twSource = 287973 },
                { id = 159407, slot = "Shoulder", name = "Lockjaw Shoulderplate", sources = { [14]=95196, [15]=95196, [16]=95196 }, twSource = 287977 },
