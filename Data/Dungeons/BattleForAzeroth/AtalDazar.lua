...
RetroRuns_DungeonData[968] = {
    ...
    bosses = {
        ...
        },
        {
            ...
            loot = {
                { id = 159233, slot = "Chest", name = "Loa Betrayer's Vestments", sources = { [14]=94967, [15]=94968, [16]=95554 }, twSource = 287992 },
                { id = 211405, slot = "Chest", name = "Loa Betrayer's Vestments", sources = { [14]=194120, [15]=194120, [16]=194120 }, twSource = 287992, mythicPlusOnly = true },
                { id = 155860, slot = "Chest", name = "Spymaster's Wrap", sources = { [14]=92510, [15]=95573, [16]=95574 }, twSource = 287980 },
                { id = 211404, slot = "Chest", name = "Spymaster's Wrap", sources = { [14]=194119, [15]=194119, [16]=194119 }, twSource = 287980, mythicPlusOnly = true },
                { id = 158308, slot = "Feet", name = "Souldrifting Sabatons", sources = { [14]=94310, [15]=94311, [16]=98382 } },
                { id = 159358, slot = "Head", name = "Coif of the Court Spider", sources = { [14]=95131, [15]=98398, [16]=98399 }, twSource = 287995 },
                { id = 211402, slot = "Head", name = "Coif of the Court Spider", sources = { [14]=194117, [15]=194117, [16]=194117 }, twSource = 287995, mythicPlusOnly = true },
                { id = 158315, slot = "Head", name = "Secret Spinner's Miter", sources = { [14]=94322, [15]=95542, [16]=95543 }, twSource = 287989 },
                { id = 211401, slot = "Head", name = "Secret Spinner's Miter", sources = { [14]=194116, [15]=194116, [16]=194116 }, twSource = 287989, mythicPlusOnly = true },
                { id = 155866, slot = "Head", name = "Soulspun Casque", sources = { [14]=92516, [15]=95620, [16]=95621 }, twSource = 287983 },
                { id = 211403, slot = "Head", name = "Soulspun Casque", sources = { [14]=194118, [15]=194118, [16]=194118 }, twSource = 287983, mythicPlusOnly = true },
                { id = 158304, slot = "Shoulder", name = "Mantle of Fastidious Machinations", sources = { [14]=94302, [15]=94303, [16]=95579 }, twSource = 287986 },
