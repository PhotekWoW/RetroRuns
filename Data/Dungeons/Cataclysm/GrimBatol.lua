    ...
    bosses = {
        {
            ...
            loot = {
                ...
                { id = 133284, slot = "Chest", name = "Cursed Skardyn Vest", sources = { [15]=76638 } },
                { id = 56443, slot = "Head", name = "Wildhammer Riding Helm", sources = { [14]=27738, [15]=27738 } },
                { id = 133285, slot = "Head", name = "Wildhammer Riding Helm", sources = { [15]=76639 } },
                { id = 133354, slot = "Legs", name = "Glimmerthread Pantaloons", sources = { [15]=76678 } },
                { id = 157596, slot = "Legs", name = "Glimmerthread Pantaloons", sources = { [14]=93785, [15]=93785 } },
                { id = 157612, slot = "Off-hand", name = "Dragonkin Ward", sources = { [14]=93798, [15]=93798 } },
                { id = 56441, slot = "Weapon", name = "Modgud's Blade", sources = { [14]=27736, [15]=76637 } },
            },
        },
        {
            index              = 2,
            ...
            loot = {
                { id = 133363, slot = "Back", name = "Troggstitched Drape", sources = { [15]=76685 } },
                ...
                { id = 133290, slot = "Feet", name = "Dark Iron Chain Boots", sources = { [15]=76642 } },
                { id = 56446, slot = "Ranged", name = "Wand of Untainted Power", sources = { [14]=27739, [15]=27739 } },
                { id = 133288, slot = "Ranged", name = "Wand of Untainted Power", sources = { [15]=76640 } },
                { id = 56447, slot = "Waist", name = "Belt of the Forgemaster", sources = { [14]=27740, [15]=27740 } },
                { id = 133289, slot = "Waist", name = "Belt of the Forgemaster", sources = { [15]=76641 } },
                { id = 157613, slot = "Weapon", name = "Geomancy Slicer", sources = { [14]=93799, [15]=93799 } },
            },
        },
        {
            index              = 3,
            ...
            loot = {
                ...
                { id = 133292, slot = "Back", name = "Azureborne Cloak", sources = { [15]=76643 } },
                { id = 157614, slot = "Feet", name = "Flame Invoker's Treads", sources = { [14]=93800, [15]=93800 } },
                { id = 56451, slot = "Feet", name = "Red Scale Boots", sources = { [14]=27743, [15]=27743 } },
                { id = 133293, slot = "Feet", name = "Red Scale Boots", sources = { [15]=76644 } },
                { id = 133374, slot = "Shoulder", name = "Courier's Dragonriding Spaulders", sources = { [15]=76691 } },
                ...
                { id = 133294, slot = "Shoulder", name = "Earthshape Pauldrons", sources = { [15]=76645 } },
                { id = 56454, slot = "Weapon", name = "Windwalker Blade", sources = { [14]=27746, [15]=27746 } },
                { id = 133296, slot = "Weapon", name = "Windwalker Blade", sources = { [15]=76647 } },
                { id = 56453, slot = "Wrist", name = "Crimsonborne Bracers", sources = { [14]=27745, [15]=27745 } },
                { id = 133295, slot = "Wrist", name = "Crimsonborne Bracers", sources = { [15]=76646 } },
            },
        },
        {
            index              = 4,
            ...
            loot = {
                ...
                { id = 133297, slot = "Chest", name = "Vest of Misshapen Hides", sources = { [15]=76648 } },
                { id = 56460, slot = "Head", name = "Crown of Enfeebled Bodies", sources = { [14]=27750, [15]=27750 } },
                { id = 133302, slot = "Head", name = "Crown of Enfeebled Bodies", sources = { [15]=76651 } },
                { id = 157615, slot = "Legs", name = "Flamescale Chain Leggings", sources = { [14]=93801, [15]=93801 } },
                { id = 56461, slot = "Two-Hand", name = "Staff of Siphoned Essences", sources = { [14]=27751, [15]=27751 } },
                { id = 133303, slot = "Two-Hand", name = "Staff of Siphoned Essences", sources = { [15]=76652 } },
                { id = 56456, slot = "Two-Hand", name = "Wild Hammer", sources = { [14]=27748, [15]=27748 } },
                { id = 133298, slot = "Two-Hand", name = "Wild Hammer", sources = { [15]=76649 } },
                { id = 56459, slot = "Weapon", name = "Mace of Transformed Bone", sources = { [14]=27749, [15]=27749 } },
                { id = 133301, slot = "Weapon", name = "Mace of Transformed Bone", sources = { [15]=76650 } },
                { id = 56464, slot = "Wrist", name = "Bracers of Umbral Mending", sources = { [14]=27752, [15]=27752 } },
                { id = 133306, slot = "Wrist", name = "Bracers of Umbral Mending", sources = { [15]=76653 } },
            },
        },
    },
}
