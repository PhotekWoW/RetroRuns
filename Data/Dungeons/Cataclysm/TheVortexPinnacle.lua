    ...
    bosses = {
        {
            ...
            loot = {
                ...
                { id = 133235, slot = "Shoulder", name = "Fallen Snow Shoulderguards", sources = { [14]=76606, [15]=76606 } },
                ...
                { id = 133232, slot = "Waist", name = "Stratosphere Belt", sources = { [14]=76603, [15]=76603 } },
                { id = 56357, slot = "Weapon", name = "Biting Wind", sources = { [14]=27683, [15]=27683 } },
                { id = 133233, slot = "Weapon", name = "Biting Wind", sources = { [14]=76604, [15]=76604 } },
            },
        },
        {
            index              = 2,
            ...
            loot = {
                { id = 133362, slot = "Back", name = "Billowing Skydrape", sources = { [14]=76684, [15]=76684 } },
                { id = 157604, slot = "Back", name = "Billowing Skydrape", sources = { [14]=93790, [15]=93790 } },
                { id = 133253, slot = "Feet", name = "Darksky Treads", sources = { [14]=76618, [15]=76618 } },
                { id = 133370, slot = "Feet", name = "Sandals of the West Wind", sources = { [14]=76689, [15]=76689 } },
                { id = 157605, slot = "Feet", name = "Sandals of the West Wind", sources = { [14]=93791, [15]=93791 } },
                { id = 133251, slot = "Ranged", name = "Thundercall", sources = { [14]=76617, [15]=76617 } },
                { id = 56361, slot = "Shoulder", name = "Mantle of Bestilled Winds", sources = { [14]=27686, [15]=27686 } },
                { id = 133237, slot = "Shoulder", name = "Mantle of Bestilled Winds", sources = { [14]=76607, [15]=76607 } },
                { id = 133371, slot = "Two-Hand", name = "Thundercleaver Axe", sources = { [14]=76690, [15]=76690 } },
                { id = 56363, slot = "Waist", name = "Hail-Strung Belt", sources = { [14]=27687, [15]=27687 } },
                { id = 133239, slot = "Waist", name = "Hail-Strung Belt", sources = { [14]=76608, [15]=76608 } },
                { id = 56364, slot = "Weapon", name = "Axe of the Eclipse", sources = { [14]=27688, [15]=27688 } },
                { id = 133240, slot = "Weapon", name = "Axe of the Eclipse", sources = { [14]=76609, [15]=76609 } },
            },
            specialLoot = {
        ...
        },
        {
            ...
            loot = {
                ...
                { id = 133245, slot = "Back", name = "Billowing Cape", sources = { [14]=76613, [15]=76613 } },
                { id = 56371, slot = "Back", name = "Shadow of Perfect Bliss", sources = { [14]=27693, [15]=27693 } },
                { id = 133247, slot = "Back", name = "Shadow of Perfect Bliss", sources = { [14]=76614, [15]=76614 } },
                { id = 56368, slot = "Hands", name = "Gloves of Haze", sources = { [14]=27691, [15]=27691 } },
                { id = 133244, slot = "Hands", name = "Gloves of Haze", sources = { [14]=76612, [15]=76612 } },
                { id = 56374, slot = "Head", name = "Lunar Halo", sources = { [14]=27694, [15]=27694 } },
                { id = 133249, slot = "Head", name = "Lunar Halo", sources = { [14]=76615, [15]=76615 } },
                { id = 56375, slot = "Legs", name = "Leggings of Iridescent Clouds", sources = { [14]=27695, [15]=27695 } },
                { id = 133250, slot = "Legs", name = "Leggings of Iridescent Clouds", sources = { [14]=76616, [15]=76616 } },
                { id = 56367, slot = "Legs", name = "Legguards of Winnowing Wind", sources = { [14]=27690, [15]=27690 } },
                { id = 133243, slot = "Legs", name = "Legguards of Winnowing Wind", sources = { [14]=76611, [15]=76611 } },
                { id = 56366, slot = "Ranged", name = "Lightningflash", sources = { [14]=27689, [15]=27689 } },
                { id = 133242, slot = "Ranged", name = "Lightningflash", sources = { [14]=76610, [15]=76610 } },
