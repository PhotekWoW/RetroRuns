    ...
    bosses = {
        ...
        },
        {
            ...
            specialLoot = {
                ...
                { id = 197401, kind = "manuscript", name = "Renewed Proto-Drake: Beaked Snout", questID = 69602 },
                { id = 197601, kind = "manuscript", name = "Windborne Velocidrake: Wavy Horns", questID = 69805 },
            },
        },
    },
}
