...
RetroRuns_DungeonData[1204] = {
    ...
    bosses = {
        ...
        },
        {
            ...
            specialLoot = {
                { id = 196975, kind = "manuscript", name = "Cliffside Wylderdrake: Head Fin", questID = 69175 },
                { id = 197007, kind = "manuscript", name = "Cliffside Wylderdrake: Wide Stripes Pattern", questID = 69207 },
            },
        },
    },
}
