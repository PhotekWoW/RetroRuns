    ...
    bosses = {
        ...
        },
        {
            ...
            specialLoot = {
                ...
                { id = 197112, kind = "manuscript", name = "Highland Drake: Single Horned Head", questID = 69313 },
                { id = 197147, kind = "manuscript", name = "Highland Drake: Heavy Scales", questID = 69348 },
            },
        },
    },
}
