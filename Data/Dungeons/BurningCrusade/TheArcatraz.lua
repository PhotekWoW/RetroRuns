    ...
    bosses = {
        {
            ...
            loot = {
                ...
                { id = 28415, slot = "Head", name = "Hood of Oblivion", sources = { [14]=12459, [15]=12459 }, setName = "Oblivion Raiment", dungeonSet = 3 },
        ...
        },
        {
            ...
            loot = {
                ...
                { id = 28414, slot = "Head", name = "Helm of Assassination", sources = { [14]=12458, [15]=12458 }, setName = "Assassination Armor", dungeonSet = 3 },
        ...
        },
        {
            ...
            loot = {
                { id = 28403, slot = "Chest", name = "Doomplate Chestguard", sources = { [14]=12448, [15]=12448 }, setName = "Doomplate Battlegear", dungeonSet = 3 },
                { id = 28391, slot = "Chest", name = "Worldfire Chestguard", sources = { [14]=12439, [15]=12439 } },
                { id = 28413, slot = "Head", name = "Hallowed Crown", sources = { [14]=12457, [15]=12457 }, setName = "Hallowed Raiment", dungeonSet = 3 },
        ...
        },
        {
            ...
            loot = {
                { id = 28205, slot = "Chest", name = "Breastplate of the Bold", sources = { [14]=12327, [15]=12327 }, setName = "Bold Armor", dungeonSet = 3 },
                { id = 28231, slot = "Chest", name = "Tidefury Chestpiece", sources = { [14]=12348, [15]=12348 }, setName = "Tidefury Raiment", dungeonSet = 3 },
