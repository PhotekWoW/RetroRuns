...
RetroRuns_Data[1098] = {
    ...
    trashLoot = {
        ...
        { id = 95516, slot = "Off-hand", name = "Visage of the Doomed", sources = { [14]=50123, [15]=50994 }, bind = "BoP" },
        { id = 95503, slot = "Ranged", name = "Miracoran, the Vehement Chord", sources = { [14]=50117, [15]=50975 }, bind = "BoP" },
        { id = 95060, slot = "Shoulder", name = "Abandoned Spaulders of Arrowflight", sources = { [14]=49848, [15]=50986 }, bind = "BoP" },
        { id = 95064, slot = "Shoulder", name = "Abandoned Spaulders of Renewal", sources = { [14]=49852, [15]=50987 }, bind = "BoP" },
        { id = 95065, slot = "Shoulder", name = "Forgotten Mantle of the Moon", sources = { [14]=49853, [15]=50984 }, bind = "BoP" },
        { id = 95062, slot = "Shoulder", name = "Forgotten Mantle of the Sun", sources = { [14]=49850, [15]=50985 }, bind = "BoP" },
        { id = 95061, slot = "Shoulder", name = "Lost Shoulders of Fire", sources = { [14]=49849, [15]=50979 }, bind = "BoP" },
        { id = 95067, slot = "Shoulder", name = "Lost Shoulders of Fluidity", sources = { [14]=49855, [15]=50981 }, bind = "BoP" },
        { id = 95066, slot = "Shoulder", name = "Lost Shoulders of Healing", sources = { [14]=49854, [15]=50980 }, bind = "BoP" },
        { id = 95068, slot = "Shoulder", name = "Reconstructed Bloody Shoulderplates", sources = { [14]=49856, [15]=50990 }, bind = "BoP" },
        { id = 95063, slot = "Shoulder", name = "Reconstructed Furious Shoulderplates", sources = { [14]=49851, [15]=50989 }, bind = "BoP" },
        { id = 95069, slot = "Shoulder", name = "Reconstructed Holy Shoulderplates", sources = { [14]=49857, [15]=50988 }, bind = "BoP" },
        { id = 95498, slot = "Two-Hand", name = "Bo-Ris, Horror in the Night", sources = { [14]=50112, [15]=50993 }, bind = "BoP" },
        { id = 95507, slot = "Two-Hand", name = "Darkwood Spiritstaff", sources = { [14]=50121, [15]=50978 }, bind = "BoP" },
        { id = 95505, slot = "Two-Hand", name = "Greatsword of Frozen Hells", sources = { [14]=50119, [15]=50991 }, bind = "BoP" },
        { id = 95499, slot = "Two-Hand", name = "Invocation of the Dawn", sources = { [14]=50113, [15]=50974 }, bind = "BoP" },
        ...
        { id = 95502, slot = "Weapon", name = "Do-tharak, the Swordbreaker", sources = { [14]=50116, [15]=50992 }, bind = "BoP" },
        { id = 95501, slot = "Weapon", name = "Fyn's Flickering Dagger", sources = { [14]=50115, [15]=50976 }, bind = "BoP" },
        { id = 95500, slot = "Weapon", name = "Jerthud, Graceful Hand of the Savior", sources = { [14]=50114, [15]=50983 }, bind = "BoP" },
        { id = 95506, slot = "Weapon", name = "Nadagast's Exsanguinator", sources = { [14]=50120, [15]=50120 }, bind = "BoP" },
        { id = 97126, slot = "Weapon", name = "Tia-Tia, the Scything Star", sources = { [14]=51412, [15]=51413 }, bind = "BoP" },
        { id = 95504, slot = "Weapon", name = "Zeeg's Ancient Kegsmasher", sources = { [14]=50118, [15]=50977 }, bind = "BoP" },
    },
    bosses = {
        {
            index              = 1,
