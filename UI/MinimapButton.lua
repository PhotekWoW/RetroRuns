...
btn:SetScript("OnEnter", function(self)
    ...
    GameTooltip:AddLine(RR.L["Left-click to toggle"], 1, 1, 1)
    GameTooltip:AddLine(RR.L["Right-click for settings"], 1, 1, 1)
    GameTooltip:AddLine(RR.L["Drag to reposition"], 0.7, 0.7, 0.7)
    GameTooltip:Show()
end)
