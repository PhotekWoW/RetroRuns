...
**Dungeons:** 59 of the 123 legacy dungeons are fully routed so far:
...
The rest, from Cataclysm and Warlords of Draenor through Dragonflight, already show their bosses, loot and entrances in the transmog browser. Routes for them are on the way.
...
All rights reserved. Free to use; see [LICENSE](LICENSE) for what is and is not permitted.
